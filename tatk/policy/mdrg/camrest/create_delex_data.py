...
from utils import dbPointer, delexicalize
...
def loadData():
    data_url = os.path.join(os.path.abspath(os.path.dirname(os.path.dirname( \
        os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(__file__))))))), "data/multi-woz/data.json")

...
DEFAULT_MODEL_URL = "https://tatk-data.s3-ap-northeast-1.amazonaws.com/sequicity_camrest.pkl"
...
class Sequicity(Agent):
    def __init__(self,
        ...
        Args:
            model_file (str):
                trained model path or url. default="https://tatk-data.s3-ap-northeast-1.amazonaws.com/sequicity_camrest.pkl"
